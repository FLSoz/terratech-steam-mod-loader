...
class TTQMMBrowserView extends react_1.Component {
    constructor(props) {
        super(props);
        ...
        return (react_1.default.createElement("div", { style: { display: 'flex', width: '100%', height: '100%' } },
            react_1.default.createElement(antd_1.Layout, { style: { minHeight: '100vh' } },
                react_1.default.createElement(Sider, { className: "MenuBar", collapsible: true, collapsed: sidebarCollapsed, onCollapse: (collapsed) => {
                    ...
                    react_1.default.createElement(MenuBar_1.default, { disableNavigation: false, currentTab: "ttqmm", history: history, location: location, match: match, appState: this.state })),
...
exports.default = (0, react_router_1.withRouter)(TTQMMBrowserView);
//# sourceMappingURL=TTQMMBrowser.js.map